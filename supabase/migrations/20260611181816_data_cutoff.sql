-- Fix: use data's own date range for cutoff, not CURRENT_DATE
-- For frozen/historical datasets, CURRENT_DATE - 12 months excludes active services
...
DECLARE
  ...
  cutoff DATE;
BEGIN
  -- Cutoff = 12 months before the LATEST transaction date in the data
