-- Update compute_daily_kpis to calculate new_clients from std_visits
-- "New client" = client_id whose first-ever visit falls on that day
...
BEGIN
  ...
  LEFT JOIN (
    -- New clients: client_id whose MIN(visit_date) falls on this day
